...
@InputType()
export class product_categoriesUpdateWithWhereUniqueWithoutProduct_categories_updated_byTousersInput {
    ...
    data!: product_categoriesUpdateWithoutProduct_categories_updated_byTousersInput;
}
